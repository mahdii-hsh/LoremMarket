  ...
  return (
    <div className='container my-6'>
      <div className='grid grid-cols-12 h-40'>
        <div className='container col-span-5 2xl:col-span-4 rounded-s-3xl relative bg-white border-e-2 border-dashed border-blue-50'>
          ...
          <div className='absolute bottom-5 start-2 rounded text-sm content-center' style={{ fontFamily: "vazirMedium" }}>
            <span className='text-blue-600'>تا ۳۰٪ تخفیف</span>
          </div>
          <div className="grid grid-cols-7 h-1/2 content-center">
            <div className='col-span-2 justify-center'>
              <TicketDiscount className=' justify-center size-10 xl:size-14 2xl:size-12 ms-4 mt-5 xl:ms-8 2xl:mt-5  bg-blue-50 p-2 2xl:p-3 rounded-xl' variant="Outline" />
            </div>
            <div className='col-span-5 content-end  ms-4 mt-5 sm:ms-3 lg:ms-0 xl:ms-0  text-sm lg:text-lg xl:text-xl 2xl:text-lg' style={{ fontFamily: "vazirBold" }}>
        ...
        <div className=" col-span-7 2xl:col-span-8 rounded-e-3xl overflow-x-auto overflow-y-hidden [scrollbar-width:none] content-center bg-white " id='discountScrollBar' >
